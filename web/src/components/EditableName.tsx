...
export function EditableName({ name, className, onClick }: EditableNameProps) {
  return (
    <button type="button" className={`group flex min-w-0 cursor-pointer items-center gap-1.5 rounded px-1.5 text-left hover:bg-dock-line hover:text-dock-ink ${className}`} title="Renommer le workspace" onClick={onClick}>
