...
const header = `<body><header><div class="eyebrow">Référence pour l’implémentation · Version 2.0</div><h1>Dock — Spécifications complètes</h1><p>Terminal Windows, workspaces libres, interface compacte verte et navigation en arborescence.</p><div class="meta"><span class="pill">24 septembre 2026</span><span class="pill">19 sections</span><span class="pill">28 scénarios de recette</span></div><p><a href="poc/index.html">Ouvrir le POC retenu ↗</a> &nbsp; · &nbsp; <a href="specifications-terminal.md">Source Markdown versionnable</a> &nbsp; · &nbsp; <a href="docs/inspection-environnement.md">Inspection de l’environnement</a></p><button type="button" onclick="window.print()">Imprimer / Enregistrer en PDF</button></header>`;
