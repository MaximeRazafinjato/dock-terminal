...
Les agents retenus sont Claude Code (`claude`) et Codex CLI (`codex`). Identifier leurs événements réels ; le simulateur agent du POC ne satisfait pas cette tâche.
